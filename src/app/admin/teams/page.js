                  ...
                  {grp.length === 0 ? (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
                        ...
                        <Link href={`/admin/teams/${t._id}`} style={{
                          ...
                          onMouseEnter={e => { e.currentTarget.style.background = 'rgba(201,162,39,0.2)'; e.currentTarget.style.borderColor = 'rgba(201,162,39,0.4)'; }}
                          onMouseLeave={e => { e.currentTarget.style.background = C.goldDim; e.currentTarget.style.borderColor = C.border; }}
                        >
